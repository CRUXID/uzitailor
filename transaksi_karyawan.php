    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="transaksi_karyawan.php" class="nav-link active">
          ...
          if(isset($_POST['InputCart']))
          {
              ...
              if($liat>0){
                ...
                if($liatlg>0){
                  ...
                  if($updateaja){
                    echo '<script>window.location="transaksi_karyawan.php"</script>';
                  } else {
                    echo '<script>window.location="transaksi_karyawan.php"</script>';
                  }
                } else {
                ...
                if ($tambahdata){
                    echo '<script>window.location="transaksi_karyawan.php"</script>';
                } else { echo '<script>window.location="transaksi_karyawan.php"</script>';
                }
                };
          } else {
  ...
  <?php 
    if(isset($_POST['import']))
    {
        ...
        if($UpdCart&&$UpdLap&&$DelCart){
          echo '<script>window.location="invoice_karyawan.php?detail='.$noinv.'"</script>';
        } else {
