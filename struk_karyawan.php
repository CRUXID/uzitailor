...
<head>
  ...
  <title>Uzi Tailor | Struk Pelunasan</title>  
</head>
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Struk Pelunasan</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <h1 class="h3 mb-2">
        ...
        <a href="progress_karyawan.php" class="btn btn-danger btn-sm px-3 mr-1">Kembali</a>
        ...
        <div class="row justify-content-end mt-1">
            <div class="col-sm-6 col-md-5 col-lg-4">
                ...
                <div class="bg-light p-2">
                    ...
                    <?php 
                      $kembalian = $Dbayar - $i4['total'];
                    ?>
                    <span class="float-right">Rp.<?php echo $kembalian; ?></span>
                    </h6>
                </div>
            </div>
        </div>
