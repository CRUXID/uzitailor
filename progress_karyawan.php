  ...
  if(isset($_POST['lunas'])) {
    ...
    if(isset($_POST['bayar'])) {
      ...
      if($bayar < $sisabayar) {
        echo "<script type='text/javascript'>
          Swal.fire({
            ...
            if(result.isConfirmed){
                window.location.href = 'pending_karyawan.php?detail=$kodetrx&jadi=$tgljadi';
            }
        })
        </script>";
        ...
        echo '<script>window.location="struk_karyawan.php?detail='.$kodetrx.'"</script>';
      }
    } else {
      $bayar = 0;
    }
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="progress_karyawan.php" class="nav-link active">
